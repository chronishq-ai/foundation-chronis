...
class TestEvaluateColdStartGated:
    ...
    def test_fitted_user_above_gate_goes_through_pipeline(self):
        ...
        On Day 35 the user is in Stage 2. Stage-2 estimates are INTERNAL ONLY
        (S10.2), so MLflow must NOT be called even though the HSSM fit ran.
        """
        ...
        # S10.2: Stage-2 internal estimates must NOT reach the MLflow audit trail
        mock_mlflow.log_params.assert_not_called()
